      ...
      <div className="main-container text-purple-100">
        ...
        <div className="md:p-4 mt-10">
          ...
          <div className="bg-black bg-opacity-35 rounded-lg md:flex items-center justify-center lg:p-9 p-3">
            ...
            <img src="/Public/Images/htmlLogo.png" alt="" className="md:h-28 h-20" />
            </div>
            {/* css-logo  */}
            <div className="lg:p-5 xs:p-3">
            <img src="/Public/Images/cssLogo.png" alt="" className="md:h-28 h-20"/>
            </div>
            {/* js-logo  */}
            <div className="lg:p-5 xs:p-3">
            <img src="/Public/Images/jsLogo.png" alt="" className="md:h-28 h-20 p-1"/>
            </div>
            </div>
